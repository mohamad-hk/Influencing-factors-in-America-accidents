...
تغییر پارامتر های مدل XGBoost تاثیر زیادی بر روی متریک های مدل نداشته است. صرفا تغییر نرخ یادگیری تاثیری کمی بر روی نتایج می داشت و در عین حال مدت زمان یادگیری هم افزایش پیدا می کرد
